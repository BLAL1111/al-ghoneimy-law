          ...
          <table className="w-full min-w-[650px]">
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                ...
                <th className="p-3 text-right text-sm font-semibold text-gray-600 dark:text-gray-300">البريد الإلكتروني</th>
                <th className="p-3 text-right text-sm font-semibold text-gray-600 dark:text-gray-300">عدد القضايا</th>
            ...
            <tbody className="divide-y dark:divide-gray-700">
              {clients.map((c: any) => (
                <tr key={c.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="p-3 text-gray-800 dark:text-gray-200">{c.phone || '—'}</td>
                  <td className="p-3 text-gray-800 dark:text-gray-200">{c.email || '—'}</td>
                  <td className="p-3 text-gray-800 dark:text-gray-200">{c.cases?.length || 0}</td>
                  <td className="p-3">
